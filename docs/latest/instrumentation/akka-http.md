---
title: 'Akka HTTP Instrumentation | Kamon Documentation'
description: 'Automatically extract metrics, distributed traces and perform context propagation on Akka HTTP applications'
layout: docs
---
...
The Akka HTTP instrumentation automatically enables Context propagation and distributed tracing for both incoming and
outgoing requests processed with Akka HTTP, as well as lower level HTTP server metrics. The gist of the features provided
...
{% include dependency-info.html module="kamon-akka-http" version=site.data.versions.latest.akka_http %}
