...
This is, by far, the most extensive release we have had to the moment. As we mentioned in the [Quick loot at Kamon
0.4.0] post a couple months ago, we decided to rework all the Kamon internals and API with one goal in mind: turn Kamon
into __the__ Monitoring tool for applications running on the JVM, and this release certainly is a bit step forward on
that direction.
...
[quick loot at kamon 0.4.0]: /teamblog/2015/03/13/quick-look-at-kamon-0.4.0/
